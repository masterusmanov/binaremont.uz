        ...
        <div class="container mx-auto px-[20px] lg:px-0 xl:px-[10px] 2xl:px-0 h-full flex items-center justify-between lg:gap-[12px] text-[#DBE7E7]">
            <div class="flex items-center gap-[24px] xl:gap-[48px]">
                ...
                <div class="hidden text-[12px] xl:text-[14px] lg:flex items-center gap-[10px] xl:gap-[24px]">
                    <router-link to="#" class="hover:translate-y-[-5px] transition-transform duration-300 ease-in-out">{{$t('header.navbar.one').toUpperCase()}}</router-link>
                    <router-link to="#" class="hover:translate-y-[-5px] transition-transform duration-300 ease-in-out">{{$t('header.navbar.two').toUpperCase()}}</router-link>
                    <router-link to="#" class="hover:translate-y-[-5px] transition-transform duration-300 ease-in-out">{{$t('header.navbar.three').toUpperCase()}}</router-link>
                    <router-link to="#" class="hover:translate-y-[-5px] transition-transform duration-300 ease-in-out">{{$t('header.navbar.four').toUpperCase()}}</router-link>
                    <router-link to="#" class="hover:translate-y-[-5px] transition-transform duration-300 ease-in-out">{{$t('header.navbar.five').toUpperCase()}}</router-link>
                    <router-link to="#" class="hover:translate-y-[-5px] transition-transform duration-300 ease-in-out">{{$t('header.navbar.six').toUpperCase()}}</router-link>
                </div>
            </div>
